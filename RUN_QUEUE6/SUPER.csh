...
set runnum = 6  #IMPORTANT!  This is the number of the directory where everything will be copied and saved in output
...
set radtype      = '3'          #3 1=RE87 relaxation; 2=interactive; 3=constant cooling (DRC 05-24-11)
 ...
 set T_tpp = '250'              #200; [K] temperature below which newtonian relaxation kicks in
##########################################################################################
