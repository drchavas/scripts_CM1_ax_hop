...
set runnum = 4  #IMPORTANT!  This is the number of the directory where everything will be copied and saved in output
...
set fcor         = '.0000125'     #.00005 CONSTANT coriolis parameter [s-1]
...
#copy statpack.F; this file includes an if statement to quit if themax < 0 (avoid blowups) 11 Jul 2012 DRC
cp statpack_blowupquit.F ${files_dir}/statpack.F
